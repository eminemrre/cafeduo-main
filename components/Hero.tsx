    ...
    >
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
          ...
          {/* Left Panel - Heading and CTA */}
          <div className="text-center lg:text-left animate-fade-in-up">
            <p className="text-xs sm:text-sm tracking-[0.3em] text-neon-pink uppercase font-bold mb-6">
              KAFEDE BEKLERKEN OYNA
            </p>

            <h1 lang="tr" className="hero-title-wrapper mb-6">
              <span className="hero-title block text-4xl sm:text-5xl lg:text-6xl leading-tight text-ink-50">
                Kafenin
              </span>
              <span className="hero-title block text-4xl sm:text-5xl lg:text-6xl leading-tight text-transparent bg-clip-text bg-gradient-to-r from-neon-blue to-neon-pink">
                Oyun Platformu
              </span>
            </h1>

            <p className="text-ink-200 text-base sm:text-lg max-w-lg mx-auto lg:mx-0 mb-8 leading-relaxed">
              ...
              {isLoggedIn ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="px-8 py-4 text-ink-50 font-sans uppercase font-bold tracking-widest text-lg border-2 border-cyber-border hover:border-neon-blue hover:bg-neon-blue/10 transition-all duration-200 flex items-center justify-center gap-3 rounded-lg"
                  >
                    OTURUM AÇ
                  </button>
                </>
          ...
          <div className="flex justify-center lg:justify-end animate-fade-in-up-slow">
            <div className="glass rounded-2xl p-6 lg:p-8 max-w-sm w-full border border-neon-blue/20 shadow-2xl">
