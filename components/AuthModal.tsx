  ...
  return (
    <AnimatePresence>
      ...
      >
        ...
        <motion.div
          className="relative w-full sm:max-w-[520px] max-h-[92vh] bg-[#050a19] border-t-2 border-r-4 border-b-4 border-l-2 border-t-cyan-400 border-r-pink-500 border-b-pink-500 border-l-cyan-400 shadow-[10px_10px_0px_rgba(0,0,0,0.8)] sm:rounded-none overflow-hidden flex flex-col noise-bg"
