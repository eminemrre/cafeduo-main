    ...
    <section id="about" className="cd-section" aria-label="Hakkımızda">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid lg:grid-cols-12 gap-6 items-stretch">
          {/* Main content */}
          <div className="lg:col-span-7 glass rounded-2xl p-7 md:p-9 border border-cyan-400/20 relative overflow-hidden">
            ...
            <div className="mt-8 grid sm:grid-cols-2 gap-3">
              {pillars.map((pillar) => (
                <article key={pillar.title} className="rounded-xl border border-cyan-400/20 bg-[#0a1834]/60 p-4 transition-colors hover:border-cyan-400/35">
                  <div className="inline-flex items-center justify-center w-8 h-8 rounded-lg bg-[#09132b] border border-cyan-400/25">
                    {pillar.icon}
                  </div>
                  <h3 className="mt-2 text-base font-semibold text-white">{pillar.title}</h3>
                  <p className="mt-1 text-xs text-ink-300">{pillar.text}</p>
                </article>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-5 flex flex-col gap-5">
            <article className="glass rounded-2xl p-6 border border-cyan-400/20">
              <div className="inline-flex items-center gap-2 text-cyan-300/80 text-[10px] uppercase tracking-wider font-bold">
                <Building2 size={14} />
                Değer Özeti
              </div>
              ...
              <div className="mt-5 grid grid-cols-3 gap-2 text-center">
                <div className="rounded-lg border border-cyan-400/18 bg-[#0a1834]/60 p-3">
                  <p className="font-display text-xl text-white">5</p>
                  <p className="text-[10px] text-cyan-300/70 uppercase">Oyun</p>
                </div>
                <div className="rounded-lg border border-cyan-400/18 bg-[#0a1834]/60 p-3">
                  <p className="font-display text-xl text-white">&lt;60 sn</p>
                  <p className="text-[10px] text-cyan-300/70 uppercase">Tur süresi</p>
                </div>
                <div className="rounded-lg border border-cyan-400/18 bg-[#0a1834]/60 p-3">
                  <p className="font-display text-xl text-white">Anlık</p>
                  <p className="text-[10px] text-cyan-300/70 uppercase">Puan</p>
                </div>
              </div>
            </article>

            <article className="glass rounded-2xl p-5 border border-cyan-400/20">
              <p className="text-[10px] uppercase tracking-wider text-cyan-300/70 font-bold">Kazanım Başlıkları</p>
